...
<head>
	...
	<title>北京信息科技大学开源镜像站-源管理</title>

</head>
<body>
<div id="wrapper">
<div id="header">
<h1>北京信息科技大学开源镜像站-源管理</h1>
<div class="tagline">
...
<table class="tablesorter" id="status-main-table">
	...
	<td class="{$site.official}"><img height="16" width="16" src="files/{$site.official}.png" alt="{$site.official}"/></td>
		...
		<td class="req_files_count"><a href='?action=delete&name={$site.name}'>删除</a></td>
		<td class="req_size"><a href='?action=edit&name={$site.name}'>修改</a></td>
	</tr>
	{/foreach}
